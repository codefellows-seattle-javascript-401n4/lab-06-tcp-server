    ...
    socket.on('data', (buffer) => {
      ...
      if (text.startsWith('@')){
        ...
        switch (newText[0]){
          ...
          case '@list':
            // Kelati code here
            // Kelati: we could also try exporting the server variable, and running server.listen in index.js instead. In lab 7 they separated the actual server from the place where you call it. up to you.
            break;
          default:
